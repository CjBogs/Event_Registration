...
<div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
  ...
  <nav class="px-6 flex flex-col space-y-3 mt-6">
    ...
    <button @click="tab = 'accountsApproval'" 
      :class="tab === 'accountsApproval' ? 'bg-[#1D503A] text-[#FAF5EE]' : 'text-[#1D503A]'" 
      class="block px-4 py-2 rounded font-semibold transition">Account Approval</button>
    <button @click="tab = 'accounts'" 
      :class="tab === 'accounts' ? 'bg-[#1D503A] text-[#FAF5EE]' : 'text-[#1D503A]'" 
      class="block px-4 py-2 rounded font-semibold transition">Accounts</button>
  </nav>
    ...
    <form action="../super_admin/update-profile.php" method="POST" class="mb-6">
      ...
      <div class="flex justify-end gap-3">
        ...
        <section x-show="tab === 'eventsApproval'" x-transition x-cloak>
            <h2 class="text-2xl font-bold mb-6 text-green-600 text-center">Events Approval</h2>
            <?php include 'home-events.php'; ?>
        </section>

        <!-- Account Approval -->
        <section x-show="tab === 'accountsApproval'" x-transition x-cloak>
            <h2 class="text-2xl font-bold mb-6 text-blue-600 text-center">Admin Account Approval</h2>
            <?php include 'account_approval.php'; ?>
        </section>

        <!-- Accounts -->
        <section x-show="tab === 'accounts'" x-transition x-cloak>
            <h2 class="text-2xl font-bold mb-6 text-green-700 text-center">All Admin Accounts</h2>
